...
<div style="background:#1e293b;color:#f1f5f9;padding:16px;border-radius:18px;
  ...
  <div style="background:#0f172a;padding:10px;border-radius:10px;margin-bottom:12px;font-size:12px">
    ...
    <div id="ew-log" style="color:#94a3b8;font-size:11px;margin-top:5px">Bekleniyor… ${isActivated() ? '✅ Lisanslı' : '🔒 Lisans Gerekli'}</div>
  </div>
  ...
  <input type="text" id="ew-cat" class="ew-inp" value="${S.themeRange}" style="margin-bottom:10px">
